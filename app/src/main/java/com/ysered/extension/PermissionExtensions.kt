 ...
 */
inline fun Activity.requestLocationPermissionsIfNeeded(requestCode: Int, onGranted: () -> Unit): Unit {
 ...
 */
inline fun Activity.requestPermissionsIfNeeded(requestCode: Int, onGranted: () -> Unit, vararg permissions: String): Unit {
